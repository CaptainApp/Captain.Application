...
namespace System.Windows.Forms
{
    ...
    public static class DragSourceHelper
    {
        ...
        {
            return new DataObject(new DragDropLib.DataObject());
        }
        ...
        public static void RegisterDefaultDragSource(Control control, IDataObject data)
        {
            ...
            entry.adviseConnection = ComDataObjectExtensions.Advise(((Runtime.InteropServices.ComTypes.IDataObject)data), new AdviseSink(data), DropDescriptionFormat, 0);
        ...
        public static void UnregisterDefaultDragSource(Control control)
        {
            if (s_dataContext.ContainsKey(control))
            {
                ...
                Runtime.InteropServices.ComTypes.IDataObject dataObjectCOM = (Runtime.InteropServices.ComTypes.IDataObject)entry.data;
        ...
        public static DragDropEffects DoDragDrop(Control control, Point cursorOffset, DragDropEffects allowedEffects, params KeyValuePair<string, object>[] data)
        {
        ...
        /// <param name="data">The associated data.</param>
        /// <returns>The accepted drop effects from the completed operation.</returns>
        public static DragDropEffects DoDragDrop(Control control, Bitmap dragImage, Point cursorOffset, DragDropEffects allowedEffects, params KeyValuePair<string, object>[] data)
        {
        ...
        private class AdviseSink : IAdviseSink
        {
            ...
            public void OnDataChange(ref FORMATETC format, ref STGMEDIUM stgmedium)
            {
                ...
                object odd = ComDataObjectExtensions.GetDropDescription((Runtime.InteropServices.ComTypes.IDataObject)data);
                if (odd != null)
